...
# --- 用户配置 ---
# 1. C语言可执行文件的路径
C_PROCESSOR_PATH = "/data1/home/renxinyu/CycDockAssem_overwrite/ALK1/fragtermgeo/calTerminalgeo" # << 请根据实际情况修改

# 2. 输入PDB文件库的路径
INPUT_PDB_DIR = "/data1/home/renxinyu/CycDockAssem_overwrite/ALK1/fraglib/Tp" # << 请根据实际情况修改

# 3. 新格式输出目录的路径 (用于存放两个大的结果文件)
OUTPUT_DIR = "/data1/home/renxinyu/CycDockAssem_overwrite/ALK1/fraglib/Tp" # << 建议明确一个输出目录

# 4. [续跑源1] 用于检查进度的旧格式文件所在目录
LEGACY_PROGRESS_DIR = "" # << 请修改为您的旧结果文件夹路径
...
# 6. 主结果文件名
MASTER_D_FILE = "d_all_4.csv"
MASTER_D_UPPER_FILE = "D_all_4.csv" # << [续跑源2] 程序也会检查此文件
